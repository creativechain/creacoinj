...
// This file shows how to use creativecoinj from Javascript.
// To run, grab the creativecoinj bundled JAR and then do something like this:
//
//   jjs -cp creativecoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp creativecoinj-0.12-bundled.jar
//
...
//
//   jjs -cp creativecoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And creativecoinj is a threaded library. This means you
