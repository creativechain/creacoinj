...
// This file shows how to use creacoinj from Javascript.
// To run, grab the creacoinj bundled JAR and then do something like this:
//
//   jjs -cp creacoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp creacoinj-0.12-bundled.jar
//
...
//
//   jjs -cp creacoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And creacoinj is a threaded library. This means you
