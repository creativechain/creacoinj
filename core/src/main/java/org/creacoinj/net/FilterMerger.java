...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.creacoinj.core.PeerFilterProvider}s, a merged
 * {@link org.creacoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.creacoinj.core.PeerGroup} class internally.</p>
 *
