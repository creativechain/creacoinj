...
import org.creacoinj.params.AbstractBitcoinNetParams;
 ...
 *
 * <ul>
 * <li>{@code creacoin:<address>}</li>
 * <li>{@code creacoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.creacoinj.params.AbstractBitcoinNetParams#CREACOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.creacoinj.core.NetworkParameters#getUriScheme} to get the scheme
     * from network parameters.
     */
    @Deprecated
    public static final String BITCOIN_SCHEME = "creacoin";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        String scheme = null == params
            ? AbstractBitcoinNetParams.CREACOIN_SCHEME
            : params.getUriScheme();
        ...
        // URI is formed as  creacoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form creacoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the creacoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : creacoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the creacoin: prefix");
