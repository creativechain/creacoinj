...
import org.creacoinj.net.NioClient;
import org.creacoinj.net.ProtobufConnection;
import org.creacoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
...
public class PaymentChannelClientConnection {
     ...
     * {@link org.creacoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
     ...
     * Attempts to open a new connection to and open a payment channel with the given host and port, blocking until the
     * connection is open.  The server is requested to keep the channel open for
     * {@link org.creacoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW} seconds.
