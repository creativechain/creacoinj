...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/creacoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/creacoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/creacoin-paymentack";
