...
import org.creacoinj.utils.BtcAutoFormat.Style;
import static org.creacoinj.utils.BtcAutoFormat.Style.*;
 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either creacoin, millicoin
 ...
 * locale, a value of one creacoin might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 BTC</code>, or one creacoin, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-creacoin value:
 *
 * <blockquote><pre>
 ...
 * method.  This argument can be either a {@link org.creacoinj.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a creacoin monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a creacoin value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a creacoin value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a creacoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a creacoin quantity of any type the
    ...
    /**
      ...
      * {@link org.creacoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
