...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of creacoinj fixes the known
     ...
     * {@link org.creacoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.creacoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.creacoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.creacoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.creacoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.creacoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.creacoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.creacoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.creacoinj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a creacoinj based app running in SPV mode to fully validating security.
     */
