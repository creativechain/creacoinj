...
public abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the creacoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the creacoin wire format.
     *
     * @param stream
     * @throws IOException
     */
