...
public class TransactionOutPoint extends ChildMessage {
    ...
    // This is not part of creacoin serialization. It points to the connected transaction.
    Transaction fromTx;
     ...
     * For P2SH scripts you can use {@link #getConnectedRedeemData(org.creacoinj.wallet.KeyBag)} and then get the
     * key from RedeemData.
