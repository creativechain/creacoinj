...
import org.creacoinj.net.AbstractTimeoutHandler;
import org.creacoinj.net.MessageWriteTarget;
 ...
 * {@link org.creacoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.creacoinj.net.NioClient} or
     * {@link org.creacoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
