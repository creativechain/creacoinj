...
import org.creacoinj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.creacoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.creacoinj.unittest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.creacoinj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.creacoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.creacoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.creacoinj.core.AlertMessage}s. You can use {@link org.creacoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
    ...
    /**
     * Scheme part for URIs, for example "creacoin".
     */
