...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.creacoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.creacoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.creacoinj.crypto.KeyCrypter,
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all creacoin controlled by that private key is lost forever).
