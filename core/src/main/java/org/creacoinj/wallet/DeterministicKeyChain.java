 ...
 * {@link org.creacoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.creacoinj.crypto.MnemonicCode},
 ...
 * {@link org.creacoinj.crypto.DeterministicKey#serializePubB58(org.creacoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.creacoinj.crypto.DeterministicKey#deserializeB58(org.creacoinj.crypto.DeterministicKey, String, org.creacoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.creacoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.creacoinj.crypto.DeterministicHierarchy} and
 * {@link org.creacoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from creacoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.creacoinj.crypto.DeterministicKey)}
     ...
     * @see org.creacoinj.wallet.MarriedKeyChain
     */
