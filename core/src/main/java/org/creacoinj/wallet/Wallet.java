...
import org.creacoinj.core.PeerFilterProvider;
...
import org.creacoinj.core.TransactionBag;
...
import org.creacoinj.core.UTXO;
import org.creacoinj.core.UTXOProvider;
import org.creacoinj.core.UTXOProviderException;
import org.creacoinj.core.Utils;
import org.creacoinj.core.VarInt;
import org.creacoinj.core.VerificationException;
import org.creacoinj.core.TransactionConfidence.*;
import org.creacoinj.crypto.*;
import org.creacoinj.script.*;
import org.creacoinj.signers.*;
import org.creacoinj.utils.*;
import org.creacoinj.wallet.Protos.Wallet.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.creacoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.creacoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.creacoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creacoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.creacoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.creacoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creacoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.creacoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.creacoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.creacoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creacoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.creacoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.creacoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creacoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of creacoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.creacoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.creacoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.creacoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.creacoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.creacoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.creacoinj.crypto.KeyCrypter,
     ...
     * {@link org.creacoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.creacoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.creacoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    /**
     * Returns the amount of creacoin ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of creacoin ever sent via output. If an output is sent to our own wallet, because of change or
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.creacoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.creacoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.creacoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
