...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link org.creacoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws org.creacoinj.crypto.MnemonicException if check fails
     */
