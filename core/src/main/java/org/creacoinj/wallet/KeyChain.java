...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.creacoinj.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the creacoinj protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.creacoinj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
