...
import org.creacoin.protocols.payments.Protos.PaymentDetails;
...
import org.creacoinj.wallet.KeyChain.KeyPurpose;
import org.creacoinj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.creacoinj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.creacoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
