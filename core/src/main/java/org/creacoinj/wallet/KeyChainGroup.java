...
/**
 * <p>A KeyChainGroup is used by the {@link org.creacoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.creacoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.creacoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.creacoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
