...
import org.creativecoinj.utils.BtcAutoFormat.Style;
import static org.creativecoinj.utils.BtcAutoFormat.Style.*;
 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either creativecoin, millicoin
 ...
 * locale, a value of one creativecoin might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 BTC</code>, or one creativecoin, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-creativecoin value:
 *
 * <blockquote><pre>
 ...
 * method.  This argument can be either a {@link org.creativecoinj.core.Coin}-type object or a
 ...
 * @see          org.creativecoinj.core.Coin
 */
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a creativecoin monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a creativecoin value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a creativecoin value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a creativecoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a creativecoin quantity of any type the
    ...
    /**
      ...
      * {@link org.creativecoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
