...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link org.creativecoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.creativecoinj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
