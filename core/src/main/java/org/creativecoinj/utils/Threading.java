 ...
 * creativecoinj performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * creativecoinj internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * creativecoinj library code is run, setting it after you started network traffic and other forms of processing
    ...
    public static class UserThread extends Thread implements Executor {
        ...
        public UserThread() {
            super("creativecoinj user thread");
            setDaemon(true);
    ...
    static {
        ...
        // instantiating any creativecoinj objects. The policy change will take effect only on new objects
