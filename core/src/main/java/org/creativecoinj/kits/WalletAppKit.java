...
package org.creativecoinj.kits;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV creativecoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit creativecoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing creativecoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.creativecoinj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the creativecoinj website
