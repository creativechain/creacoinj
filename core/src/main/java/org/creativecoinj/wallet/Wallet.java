...
import org.creativecoinj.core.PeerFilterProvider;
...
import org.creativecoinj.core.TransactionBag;
...
import org.creativecoinj.core.UTXO;
import org.creativecoinj.core.UTXOProvider;
import org.creativecoinj.core.UTXOProviderException;
import org.creativecoinj.core.Utils;
import org.creativecoinj.core.VarInt;
import org.creativecoinj.core.VerificationException;
import org.creativecoinj.core.TransactionConfidence.*;
import org.creativecoinj.crypto.*;
import org.creativecoinj.script.*;
import org.creativecoinj.signers.*;
import org.creativecoinj.utils.*;
import org.creativecoinj.wallet.Protos.Wallet.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.creativecoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.creativecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.creativecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creativecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.creativecoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.creativecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creativecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.creativecoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.creativecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.creativecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creativecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.creativecoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.creativecoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.creativecoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of creativecoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.creativecoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.creativecoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.creativecoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.creativecoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.creativecoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.creativecoinj.crypto.KeyCrypter,
     ...
     * {@link org.creativecoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.creativecoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.creativecoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    /**
     * Returns the amount of creativecoin ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of creativecoin ever sent via output. If an output is sent to our own wallet, because of change or
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.creativecoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.creativecoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.creativecoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
