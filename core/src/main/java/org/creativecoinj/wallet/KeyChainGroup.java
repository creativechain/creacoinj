...
/**
 * <p>A KeyChainGroup is used by the {@link org.creativecoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.creativecoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.creativecoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.creativecoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
