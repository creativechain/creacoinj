...
/**
 * Network parameters used by the creativecoinj unit tests (and potentially your own). This lets you solve a block using
 * {@link org.creativecoinj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
