 ...
 * creativecoinj for a specific network. You can get an instance of this class through calling {@link #get()}.</p>
 *
...
public class Context {
    ...
    public Context(NetworkParameters params) {
        log.info("Creating creativecoinj {} context.", VersionMessage.BITCOINJ_VERSION);
     ...
     * independently use creativecoinj (or possibly alt coin forks of it) can operate correctly.
     *
    ...
    public static Context get() {
        ...
        if (tls == null) {
            if (isStrictMode) {
                log.error("Thread is missing a creativecoinj context.");
                log.error("You should use Context.propagate() or a ContextPropagatingThreadFactory.");
                throw new IllegalStateException("missing context");
            }
            if (lastConstructed == null)
                throw new IllegalStateException("You must construct a Context object before using creativecoinj!");
            slot.set(lastConstructed);
            log.error("Performing thread fixup: you are accessing creativecoinj via a thread that has not had any context set on it.");
    ...
    /**
     * Require that new threads use {@link #propagate(Context)} or {@link org.creativecoinj.utils.ContextPropagatingThreadFactory},
     ...
     * a {@link org.creativecoinj.utils.ContextPropagatingThreadFactory}.
     */
    ...
    /**
     * Returns the {@link org.creativecoinj.core.NetworkParameters} specified when this context was (auto) created. The
