...
public abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the creativecoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the creativecoin wire format.
     *
     * @param stream
     * @throws IOException
     */
