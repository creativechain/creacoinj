...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of creativecoinj fixes the known
     ...
     * {@link org.creativecoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.creativecoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.creativecoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.creativecoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.creativecoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.creativecoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.creativecoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.creativecoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.creativecoinj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a creativecoinj based app running in SPV mode to fully validating security.
     */
