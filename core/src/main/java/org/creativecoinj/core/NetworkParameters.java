...
import org.creativecoinj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.creativecoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.creativecoinj.unittest";
    ...
    public static final long KECCAK_TIME = 0L;
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.creativecoinj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.creativecoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.creativecoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.creativecoinj.core.AlertMessage}s. You can use {@link org.creativecoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
    ...
    /**
     * Scheme part for URIs, for example "creativecoin".
     */
