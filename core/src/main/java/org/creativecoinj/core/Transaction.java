...
public class Transaction extends ChildMessage {
    ...
    // These are creativecoin serialized.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.creativecoinj.script.Script, ECKey, org.creativecoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.creativecoinj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.creativecoinj.core.TxConfidenceTable}
