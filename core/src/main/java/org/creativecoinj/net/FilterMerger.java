...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.creativecoinj.core.PeerFilterProvider}s, a merged
 * {@link org.creativecoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.creativecoinj.core.PeerGroup} class internally.</p>
 *
